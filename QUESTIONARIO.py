# Por mais que as respostas 2 e 3 da pergunta "Como você está se sentindo hoje" levem ao mesmo resultado nesse protótipo, existe a possibilidade de personalização.
# Perguntas são meramente ILUSTRATIVAS assim como as dicas ao final do questionário. NÃO se deve segui-las.
# Caso for utilizar, coloque perguntas e dicas com embasamentos.
while True:
  try:
    ...
    if 1 <= p1 <= 3:
      ...
      print("Escolha um número entre as opções. Tente novamente.")
  except:
